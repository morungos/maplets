...
//        '<button id="restoreDefaultRegionButton" class="t_button"><i class="icon-repeat"></i></button> ' +
        ...
        '<button id="zoomOutButton" class="t_button"><i class="icon-zoom-out"></i></button>' +
        '<span style="margin:0 15px"><div id="slider" style="width:100px" ></div></span>' +
        '<button id="zoomInButton" class="t_button"><i class="icon-zoom-in"></i></button> ' +
        '</span>';

//        icon-repeat
    this.targetDiv = target[0];
    this.div = jQuery('<div style="padding: 1rem; vertical-align: middle;float:right;margin-top: -4.7rem" ' +
