...
function CapsidGeneAdapter(args) {
...
CapsidGeneAdapter.prototype.clearData = function () {
    this.featureCache.clear();
};

CapsidGeneAdapter.prototype.setFilters = function (filters) {
    this.clearData();
...
CapsidGeneAdapter.prototype.setOption = function (opt, value) {
    if (opt.fetch) {
        this.clearData();
    }
...
CapsidGeneAdapter.prototype.getData = function (args) {
    var _this = this;
...
CapsidGeneAdapter.prototype._callWebService = function (segmentString, callback, params) {
    var callParams = {
    ...
    var url = 'api/browser/gene' + this._getQuery(callParams);
    $.ajax({
        type: 'GET',
        url: url,
...
CapsidGeneAdapter.prototype._getQuery = function (paramsWS) {
    var query = "";
