...
d3.tsv("mapped_gra_small.txt").get(function(error, rows) { 
...
function getChildren(d) {
	...
	return children ? children.map(function(id) { return identifiers[id]; }) : [];
}
...
function generateSunburst() {
	...
	var initialNodes = identifiers[0].children;
